...
router.get("/me", auth_js_1.default, (0, asyncHandler_js_1.asyncHandler)(async (req, res) => {
    const user = await userService_js_1.UserService.getUserProfile(req.user.id);
    res.json(user);
}));
// Login with Zod validation
router.post("/login", (0, simpleValidation_js_1.validateBody)(schemas_js_1.userLoginSchema), (0, asyncHandler_js_1.asyncHandler)(async (req, res) => {
...
// Register
router.post("/register", (0, simpleValidation_js_1.validateBody)(schemas_js_1.userRegistrationSchema), (0, asyncHandler_js_1.asyncHandler)(async (req, res) => {
...
// Update daily goal
router.put("/daily-goal", auth_js_1.default, (0, simpleValidation_js_1.validateBody)(schemas_js_1.dailyGoalSchema), (0, asyncHandler_js_1.asyncHandler)(async (req, res) => {
...
// Update user image
router.put("/me/image", auth_js_1.default, (0, fileUpload_js_1.validateImageUpload)(schemas_js_1.avatarUploadSchema), (0, asyncHandler_js_1.asyncHandler)(async (req, res) => {
...
// Buy item
router.post("/buyItem", auth_js_1.default, (0, simpleValidation_js_1.validateBody)(schemas_js_1.itemPurchaseSchema), (0, asyncHandler_js_1.asyncHandler)(async (req, res) => {
...
// Remove item
router.post("/removeItem", auth_js_1.default, (0, simpleValidation_js_1.validateBody)(schemas_js_1.itemPurchaseSchema), (0, asyncHandler_js_1.asyncHandler)(async (req, res) => {
    const { itemId } = req.validatedBody;
...
// Upgrade item
router.post("/upgradeItem", auth_js_1.default, (0, simpleValidation_js_1.validateBody)(schemas_js_1.itemUpgradeSchema), (0, asyncHandler_js_1.asyncHandler)(async (req, res) => {
    const { itemId } = req.validatedBody;
...
router.post("/addHeroBonus", auth_js_1.default, (0, simpleValidation_js_1.validateBody)(schemas_js_1.addHeroBonusSchema), (0, asyncHandler_js_1.asyncHandler)(async (req, res) => {
...
router.post("/onEnemyDefeat", auth_js_1.default, (0, simpleValidation_js_1.validateBody)(schemas_js_1.onEnemyDefeatSchema), (0, asyncHandler_js_1.asyncHandler)(async (req, res) => {
    const { type, amount, coinsDrop } = req.validatedBody;
    const result = await userService_js_1.UserService.onEnemyDefeat(type, amount, coinsDrop, req.user.id);
    res
        .status(200)
        .json((0, simpleValidation_js_1.createSuccessResponse)(result, "Enemy defeated successfully"));
}));
// Verify token
